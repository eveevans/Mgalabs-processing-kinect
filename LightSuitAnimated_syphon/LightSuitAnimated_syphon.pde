...
void draw() {
  ...
  if(sk_right_hand.y > 0 && sk_right_hand.y <= 160){
     canvas.image(suits[2], sk_torso.x-320, sk_torso.y-240);
   }
   else if(sk_right_hand.y > 160 && sk_right_hand.y <= 220){
     canvas.image(suits[1], sk_torso.x-320, sk_torso.y-240);
   }
   else {
     canvas.image(suits[0], sk_torso.x-320, sk_torso.y-240);
   }
